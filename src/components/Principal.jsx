    ...
    const navigate = useNavigate();
        ...
        <div>
            ...
            <div className="grid grid-cols-4 gap-2 text-center mt-25">
                ...
                <button className="col-span-1 rounded-lg cursor-pointer block m-10 bg-amber-600 text-2xl font-bold border-black border-4 h-24">GUIAS</button>
                <button className="col-span-1 rounded-lg cursor-pointer block m-10 bg-amber-600 text-2xl font-bold border-black border-4 h-24">INFORMACIÓN GENERAL</button>
