    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-4 gap-2 text-center">
                <button className="col-span-1 rounded-lg cursor-pointer block m-10 bg-amber-600 text-2xl font-bold border-black border-4 h-25 col-start-1" onClick={() => setCurrentComponent('Rutas')}>RUTAS</button>
            ...
            <button className='m-10 rounded-lg bg-amber-600 cursor-pointer text-2xl border-black border-4 p-5 place-items-center' onClick={() => setCurrentComponent('Login')}>Iniciar Sección</button>
        </div>
