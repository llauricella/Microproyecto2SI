...
export default function ModificarUsuarios() {
    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="bg-gray-200 p-10 rounded-xl shadow-lg w-full max-w-4xl h-full overflow-y-auto">
                <h1 className="text-3xl font-bold mb-4 text-center">Modificar Usuarios</h1>
                ...
                <table className="min-w-full bg-white">
                    <thead>
                        <tr>
                            ...
                            <th className="py-2 px-4 border-b text-center">Cambiar tipo</th>
                        </tr>
                    </thead>
                    <tbody>
                        {usuarios.map(usuario => (
                            <tr key={usuario.id}>
                                <td className="py-2 px-4 border-b text-center">{usuario.name}</td>
                                <td className="py-2 px-4 border-b text-center">{usuario.email}</td>
                                <td className="py-2 px-4 border-b text-center">{usuario.type}</td>
